...
async function operateNode(endpoint) {
    ...
    console.log(response, fetchedJson)
    // const fetchedJson        // デモデータ
    //     = '{"prev_data":'
...
function startFetch() {
    ...
    if (!loopId) {
        ...
        loopId = setInterval(operateNode, intervalTime, "https://eagitrodev.pythonanywhere.com/m5stick_tennis/data");
